...
use SchilinskiAlexander\MoonShineRegister\Forms\ForgotPasswordForm;
...
final class ForgotPasswordPage extends Page
{
    ...
    {
        $this->title(__('moonshine-register::register.forgot_title'));
    }
    ...
    protected function modifyLayout(\MoonShine\Contracts\UI\LayoutContract $layout): \MoonShine\Contracts\UI\LayoutContract
    {
        if ($layout instanceof LoginLayout) {
            $layout
                ->title(__('moonshine-register::register.forgot_title'))
                ->description(__('moonshine-register::register.forgot_description'));
        }
